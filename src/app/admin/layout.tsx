...
import { FileText, Home, Menu, Package, Percent, Settings, ShoppingCart, Tag, Users } from "lucide-react";
...
export default function AdminLayout({ children }: AdminLayoutProps) {
	...
	const Sidebar = ({ mobile = false }: { mobile?: boolean }) => (
		<div className={cn("flex flex-col h-full bg-orange-50 border-r border-orange-200", mobile && "w-64")}>
			<div className="flex items-center justify-center h-16 px-4 border-b border-orange-200">
				<h1 className="text-xl font-bold text-orange-800">Sanathan Admin</h1>
			</div>

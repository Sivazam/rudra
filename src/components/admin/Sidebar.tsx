...
export function Sidebar({ isOpen = false, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute bottom-0 w-64 p-4 border-t border-gray-200">
          <button
            ...
            className="flex items-center w-full px-3 py-3 text-sm font-medium text-gray-700 rounded-md hover:bg-gray-100 hover:text-gray-900"
          >
      ...
      {/* Desktop sidebar */}
      <div className="hidden lg:block w-64 bg-white shadow-sm border-r border-gray-200 min-h-screen fixed left-0 top-16">
        <div className="p-6">
          <h1 className="text-xl font-bold text-gray-900">Rudra Admin</h1>
        </div>
